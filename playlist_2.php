    ...
    <main>
        <section class="sidebar">
            ...
            <div class="library">
                ...
                <div class="playlist-sidebar">
                    <a href="playlist_2.php?id=7" style="color:#1ed760;">Best of 2017 </a>
                </div>
            </div>
        </section>
        <section class="playlist-hero-sec">
            <?php 
                $playlist_1 = $conn->query('SELECT * FROM all_tracks WHERE id = 7');
            ...
            <table class="playlist">
                ...
                <?php 
                    $music = $conn->query('SELECT * FROM playlist_2');
