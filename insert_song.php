    ...
    <main>
        <section class="sidebar">
            <div class="browse">
                ...
                <a href="insert_song.php" style="color:#1ed760;">Add new Song</a>
            </div>
            <div class="library">
        ...
        <section class="login-hero-sec">
            <div>
                <form action="insert_song_db.php" method="post" enctype="multipart/form-data">
                    <p class="add-song-head">Add New Song </p>
                    <label for="track_name">Track Name</label><br>
                    <input type="text" name="track_name" id="track_name" required><br>
                    <label for="track_album">Track Album</label><br>
                    <input type="text" name="track_album" id="track_album" required><br>
                    <label for="track_artist">Track Artist</label><br>
                    <input type="text" name="track_artist" id="track_artist" required><br>
                    <label for="image">Image</label><br>
                    <input type="file" name="image" id="image" required><br>
                    <label for="audio">Audio</label><br>
                    <input type="file" name="audio" id="audio" required><br>
